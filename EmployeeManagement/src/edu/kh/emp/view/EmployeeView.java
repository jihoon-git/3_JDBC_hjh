...
//				salary, deptCode, jobCode, salLevel, bonus, managerId);
		...
		Employee emp = new Employee(empId, empName, empNo, email, phone, email, 
				phone, salary, deptCode, jobCode, salLevel, bonus, managerId);
		
		
		int result = dao.insertEmployee(emp);
		// INSERT, UPDATE, DELETE 같은 DMP 구문은
	...
	public void selectSalaryEmp() {
		...
		List<Employee> selectSalaryEmp = dao.selectSalaryEmp(empSalary);
		 
		printAll(selectSalaryEmp);
