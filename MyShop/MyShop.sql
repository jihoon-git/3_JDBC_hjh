...
-- 상품 샘플 데이터 INSERT
INSERT INTO TB_SNACK
VALUES (SEQ_SNACK_NO.NEXTVAL, '몽쉘 카카오맛', 3500);
INSERT INTO TB_SNACK
VALUES (SEQ_SNACK_NO.NEXTVAL, '포카칩 오리지널맛', 1500);
INSERT INTO TB_SNACK
VALUES (SEQ_SNACK_NO.NEXTVAL, '포카칩 어니언맛', 1500);
INSERT INTO TB_SNACK
VALUES (SEQ_SNACK_NO.NEXTVAL, '프링글스 치즈맛', 2000);
INSERT INTO TB_SNACK
VALUES (SEQ_SNACK_NO.NEXTVAL, '프링글스 오리지널맛', 2000);
INSERT INTO TB_SNACK
VALUES (SEQ_SNACK_NO.NEXTVAL, '꼬북칩', 1500);
INSERT INTO TB_SNACK
VALUES (SEQ_SNACK_NO.NEXTVAL, '콘칩', 1500);
INSERT INTO TB_SNACK
VALUES (SEQ_SNACK_NO.NEXTVAL, '웨하스 바닐라맛', 1000);
INSERT INTO TB_SNACK
VALUES (SEQ_SNACK_NO.NEXTVAL, '웨하스 딸기맛', 1000);
...
CREATE TABLE TB_ORDER(
	...
	SHIPPING_CODE VARCHAR2(10) REFERENCES TB_SHIPPING(SHIPPING_CODE),
...
--VALUES (SEQ_ORDER_NO.NEXTVAL, 5, DEFAULT, 1, , '')

-- 주문 내역 메뉴
-- 내 주문 내역 조회
-- 주문옵션/수량 변경 (주문번호 입력받아 상품명/수량 변경)(배송 상태가 출고 전이어야 함)
